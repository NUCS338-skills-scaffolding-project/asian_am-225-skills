# demo.py — Claim Verification Skill Demo

from logic import run

sample_input = {
  "claim": (
      "Asian Americans are treated as perpetual foreigners in the United States, "
      "regardless of how long they or their families have lived here."
  ),
  "evidence": (
      "A personal experience of being asked 'where are you really from?' "
      "at a university event despite being born and raised in Chicago. "
  ),
  "readings": (),
  "context": ("""
      ...
      Reflect upon the way in which theories and research from the social and behavioral sciences help elucidate the factors underlying contemporary social issues, social problems, and/or ethical dilemmas in the U.S. and/or abroad, as well as inform potential solutions to societal problem
      """
  ),
}
...
if __name__ == "__main__":
  print("=" * 60)
  print("Claim Verification Skill — Demo Run")
  print("=" * 60)

  print("\n[CLAIM]")
  print(f"  {sample_input['claim']}")

  print("\n[EVIDENCE]")
  print(f"  {sample_input['evidence']}")

  print("\n[READINGS]")
  print(f"  {sample_input['readings']}")

  print("\n[CONTEXT]")
  print(f"  {sample_input['context']}")
